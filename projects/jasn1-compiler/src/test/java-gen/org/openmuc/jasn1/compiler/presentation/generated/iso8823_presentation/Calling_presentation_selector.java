...
public class Calling_presentation_selector extends Presentation_selector {

	public Calling_presentation_selector() {
	}

	public Calling_presentation_selector(byte[] value) {
		super(value);
	}
